...
const fetchImage = async () => {
  ...
  let kittenImgUrl = localStorage.getItem("cat-image");
  console.log("cat image", kittenImgUrl);
  ...
  if (kittenImgUrl) {
    ...
    try {
      ...
      localStorage.setItem("cat-image", kittenImgUrl);
      const kittenImg = document.querySelector("img");
      kittenImg.src = kittenImgUrl;
...
const createNewKittenBtn = () => {
  ...
  newKittenBtn.addEventListener("click", getNewCat);
  return newKittenBtn;
};
